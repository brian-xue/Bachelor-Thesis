...
MIRROR_PORT = PORT_3_ID
MIRROR_SESSION_TO_MONITOR = 777 # mirroring's session id for sniffing RDMA packets for IG_MIRROR
...
bfrt.mirror.cfg.add_with_normal(sid=MIRROR_SESSION_TO_MONITOR,
                                direction='INGRESS',
                                session_enable=True,
